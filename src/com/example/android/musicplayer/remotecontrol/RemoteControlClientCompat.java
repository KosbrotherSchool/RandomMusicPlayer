...
package com.example.android.musicplayer.remotecontrol;
 ...
 * 
 *  RemoteControlClient 是可以顯示一些資訊提供給 RemoteControl 使用
 *  這裡我們取得了 android.media.RemoteControlClient, 因此我們在 LockScreen 時會看到一些 Radio Button,
 *  必須寫 Receiver 來處理這些 Button
 *
 * 
 */
...
public class RemoteControlClientCompat {
    ...
    static {
        try {
        	// ClassLoader 讀取 Classes or Resources, 
        	// 這裡透過 getActualRemoteControlClientClass() 取得 RemoteControlClient 
            ...
            // in future versions.
            // 這裡要撰寫動態顯示, 因為顯示方式可能會因 SDK 的 version 而變.
            // field 是屬性
    ...
    // Handler處理message, Looper 則開一個執行序執行 Handler 接收到的事項 
     ...
     * 一但 #apply() 後, 就不能重新使用同一個 MetadataEditor
     * 
     */
    public class MetadataEditorCompat {
         ...
         *      calls together.
         *      
         *      Media 的 MetaData 有些 Key (Android)已經預設了. 方便使用.
         */
