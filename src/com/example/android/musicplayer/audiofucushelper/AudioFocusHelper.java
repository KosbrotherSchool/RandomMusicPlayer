...
package com.example.android.musicplayer.audiofucushelper;
 ...
 * 
 * 
 * 在 Android 中可能有許多播放 Media 的 APP, Android 透過 Audio Focus 來調節哪個 APP 可以取得目前的播放權限.
 * 因此, 這個 Class 會處理 request, abandon focus, 也會 Listen to focus change event, 
 * 並且讓實作它的介面(也就是 MusicService)知道.
 * 
 */
@SuppressLint("NewApi")
